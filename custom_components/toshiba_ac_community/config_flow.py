...
class OptionsFlow(config_entries.OptionsFlow):
    """Handle Toshiba AC integration options."""
    ...
    async def async_step_init(
        ...
        """Manage the energy polling interval."""
        ...
        schema = vol.Schema(
            {
                vol.Required(
                    CONF_ENERGY_POLL_INTERVAL, default=current_interval
                ): vol.In(ENERGY_POLL_INTERVAL_OPTIONS),
            }
        )
